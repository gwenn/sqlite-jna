...
class Stmt implements Statement {
	...
	Stmt(Conn c, org.sqlite.Stmt stmt, boolean autoGeneratedKeys) {
		this.c = c;
		this.stmt = stmt;
	...
	public int executeUpdate(String sql, int autoGeneratedKeys) throws SQLException {
		final boolean keys = Conn.checkAutoGeneratedKeys(autoGeneratedKeys);
		final int changes = executeUpdate(sql);
		this.autoGeneratedKeys = keys;
		return changes;
	}
	//#if mvn.project.property.large.update == "true"
	//#if mvn.project.property.jdbc.specification.version >= "4.2"
	...
	public long executeLargeUpdate(String sql, int autoGeneratedKeys) throws SQLException {
		final boolean keys = Conn.checkAutoGeneratedKeys(autoGeneratedKeys);
		final long changes = executeLargeUpdate(sql);
		this.autoGeneratedKeys = keys;
		return changes;
	}
	//#endif
	...
	public boolean execute(String sql, int autoGeneratedKeys) throws SQLException {
		final boolean keys = Conn.checkAutoGeneratedKeys(autoGeneratedKeys);
		final boolean resultset = execute(sql);
		this.autoGeneratedKeys = keys;
		return resultset;
	}
