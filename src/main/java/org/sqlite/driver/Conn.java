...
class Conn implements Connection {
	...
	public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency, int resultSetHoldability) throws SQLException {
		final org.sqlite.Conn c = getConn();
		checkCursor(resultSetType, resultSetConcurrency, resultSetHoldability);
		return new PrepStmt(this, c.prepare(sql, true), false);
	}
	...
	public PreparedStatement prepareStatement(String sql, int autoGeneratedKeys) throws SQLException {
		if (checkAutoGeneratedKeys(autoGeneratedKeys)) {
			final org.sqlite.Conn c = getConn();
			return new PrepStmt(this, c.prepare(sql, true), true);
		}
	...
	static boolean checkAutoGeneratedKeys(int autoGeneratedKeys) throws SQLException {
		...
		return Statement.RETURN_GENERATED_KEYS == autoGeneratedKeys;
	}
