...
class Conn implements Connection {
	...
	final String @NonNull[] dateTimeConfig;
	...
	public void setReadOnly(boolean readOnly) throws SQLException {
		checkOpen();
		boolean ro = c.isReadOnly(null);
		boolean qo = c.isQueryOnly(null);
	...
	@Override
	public PreparedStatement prepareStatement(@NonNull String sql, int resultSetType, int resultSetConcurrency) throws SQLException {
	...
	@Override
	@NonNull
	public PreparedStatement prepareStatement(@NonNull String sql, int resultSetType, int resultSetConcurrency, int resultSetHoldability) throws SQLException {
		org.sqlite.Conn c = getConn();
		checkCursor(resultSetType, resultSetConcurrency, resultSetHoldability);
	...
	@Override
	@NonNull
	public PreparedStatement prepareStatement(@NonNull String sql, int autoGeneratedKeys) throws SQLException {
		Generated generated = checkAutoGeneratedKeys(autoGeneratedKeys);
		org.sqlite.Conn c = getConn();
	...
	@Override
	public PreparedStatement prepareStatement(@NonNull String sql, String @Nullable[] columnNames) throws SQLException {
		checkOpen();
	...
	@Override
	public void setClientInfo(String name, @Nullable String value) {
		//checkOpen();
	...
	static boolean empty(int @Nullable[] columnIndexes) {
		return columnIndexes == null || columnIndexes.length == 0;
	}
	static boolean empty(String @Nullable[] columnNames) {
