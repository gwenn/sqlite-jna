...
public interface ExtErrCodes {
	int SQLITE_ERROR_MISSING_COLLSEQ = ErrCodes.SQLITE_ERROR | 1 << 8;
	int SQLITE_ERROR_RETRY = ErrCodes.SQLITE_ERROR | 2 << 8;
	int SQLITE_ERROR_SNAPSHOT = ErrCodes.SQLITE_ERROR | 3 << 8;
	...
	int SQLITE_IOERR_DELETE_NOENT = ErrCodes.SQLITE_IOERR | 23 << 8;
	int SQLITE_IOERR_MMAP = ErrCodes.SQLITE_IOERR | 24 << 8;
	int SQLITE_IOERR_GETTEMPPATH = ErrCodes.SQLITE_IOERR | 25 << 8;
	int SQLITE_IOERR_CONVPATH = ErrCodes.SQLITE_IOERR | 26 << 8;
	int SQLITE_IOERR_VNODE = ErrCodes.SQLITE_IOERR | 27 << 8;
	int SQLITE_IOERR_AUTH = ErrCodes.SQLITE_IOERR | 28 << 8;
	int SQLITE_IOERR_BEGIN_ATOMIC = ErrCodes.SQLITE_IOERR | 29 << 8;
	int SQLITE_IOERR_COMMIT_ATOMIC = ErrCodes.SQLITE_IOERR | 30 << 8;
	int SQLITE_IOERR_ROLLBACK_ATOMIC = ErrCodes.SQLITE_IOERR | 31 << 8;
	int SQLITE_IOERR_DATA = ErrCodes.SQLITE_IOERR | 32 << 8;
	int SQLITE_IOERR_CORRUPTFS = ErrCodes.SQLITE_IOERR | 33 << 8;
	int SQLITE_IOERR_IN_PAGE = ErrCodes.SQLITE_IOERR | 34 << 8;

	int SQLITE_LOCKED_SHAREDCACHE = ErrCodes.SQLITE_LOCKED | 1 << 8;
	int SQLITE_LOCKED_VTAB = ErrCodes.SQLITE_LOCKED |  2 << 8;

	int SQLITE_BUSY_RECOVERY = ErrCodes.SQLITE_BUSY | 1 << 8;
	int SQLITE_BUSY_SNAPSHOT = ErrCodes.SQLITE_BUSY   |  2 << 8;
	int SQLITE_BUSY_TIMEOUT = ErrCodes.SQLITE_BUSY   |  3 << 8;

	int SQLITE_CANTOPEN_NOTEMPDIR = ErrCodes.SQLITE_CANTOPEN | 1 << 8;
	int SQLITE_CANTOPEN_ISDIR = ErrCodes.SQLITE_CANTOPEN | 2 << 8;
	int SQLITE_CANTOPEN_FULLPATH = ErrCodes.SQLITE_CANTOPEN | 3 << 8;
	int SQLITE_CANTOPEN_CONVPATH = ErrCodes.SQLITE_CANTOPEN | 4 << 8;
	int SQLITE_CANTOPEN_DIRTYWAL = ErrCodes.SQLITE_CANTOPEN | 5 << 8; /* Not Used */
	int SQLITE_CANTOPEN_SYMLINK = ErrCodes.SQLITE_CANTOPEN | 6 << 8;

	int SQLITE_CORRUPT_VTAB = ErrCodes.SQLITE_CORRUPT | 1 << 8;
	int SQLITE_CORRUPT_SEQUENCE = ErrCodes.SQLITE_CORRUPT | 2 << 8;
	int SQLITE_CORRUPT_INDEX = ErrCodes.SQLITE_CORRUPT | 3 << 8;
	...
	int SQLITE_READONLY_CANTINIT = ErrCodes.SQLITE_READONLY | 5 << 8;
	int SQLITE_READONLY_DIRECTORY = ErrCodes.SQLITE_READONLY | 6 << 8;
	...
	int SQLITE_CONSTRAINT_PINNED = ErrCodes.SQLITE_CONSTRAINT |11 << 8;
	int SQLITE_CONSTRAINT_DATATYPE = ErrCodes.SQLITE_CONSTRAINT |12 << 8;

	//int SQLITE_NOTICE_RECOVER_WAL = ErrCodes.SQLITE_NOTICE | 1 << 8;
	//int SQLITE_NOTICE_RECOVER_ROLLBACK = ErrCodes.SQLITE_NOTICE | 2 << 8;
	//int SQLITE_NOTICE_RBU = ErrCodes.SQLITE_NOTICE | 3 << 8;

	//int SQLITE_WARNING_AUTOINDEX = ErrCodes.SQLITE_WARNING | 1 << 8;
	int SQLITE_AUTH_USER = ErrCodes.SQLITE_AUTH | 1 << 8;
	int SQLITE_OK_LOAD_PERMANENTLY = ErrCodes.SQLITE_OK | 1 << 8;
	int SQLITE_OK_SYMLINK = ErrCodes.SQLITE_OK | 2 << 8;
}
